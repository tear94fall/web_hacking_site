...
<body>
    ...
    $sql = "update notice_board set view='$view'";
    $sql .= " where idx='$index'";
    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <form id="insert_hack_issue" action="notice_modify.php?index=<?php echo $index ?>&page=<?php echo $page ?>"
                ...
                <tr>
                    <td colspan="3">
                        <a class="btn btn-default" href="notice_list.php?page=<?php echo $page ?>">글 목록으로</a>
                        <a class="btn btn-default pull-right"
                        onclick="document.getElementById('insert_hack_issue').submit();"> 수정하기 </a>
                        <a class="btn btn-default pull-right"
                        href="notice_delete.php?index=<?php echo $index ?>&page=<?php echo $page ?>"> 삭제하기 </a>
                    </td>
                </tr>
            </form>
        </table>
