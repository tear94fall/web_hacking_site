...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <form id="insert_freeboard"action="freeboard_insert.php" method="post" encType="multiplart/form-data">
                    <tr>
                        <th>제목:</th>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <a class="btn btn-default pull-right" onclick="document.getElementById('insert_freeboard').submit();"> 등록 </a>
                        </td>
                    </tr>
                </form>
            </tbody>
