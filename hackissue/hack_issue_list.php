    ...
    <div class="issue_table">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM hack_issue order by idx desc;";
                ...
                // 하나의 레코드 가져오기
                    ...
                    echo "<tr>
                    <td>$number</td>
                    <td><a href='hack_issue_view.php?index=$index&page=$page'>$subject</a></td>
                    <td>$writer</td>
                    <td>$register_date</td>
                    <td>$view</td>
                    </tr>";
        ...
        if ($userid) {
            echo "<a class='btn btn-default pull-right' href='hack_issue_write.php'>글쓰기</a><br><br>";
        }
        ?>
        </div>
    </div>
            ...
            if($total_page==0){
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    if ($page == $i) {
                        ...
                        echo "<li><a href='hack_issue_list.php?page=$i'>$i</a></li>";
                    }
                }
            }
            ?>
