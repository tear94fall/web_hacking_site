...
<body>
    ...
    $sql = "update freeboard set view='$view'";
    $sql .= " where idx='$index'";
...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <form id="insert_freeboard" action="freeboard_modify.php?index=<?php echo $index ?>&page=<?php echo $page ?>"
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    class="form-control"><?php echo nl2br($content); ?></textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">
                    <a class="btn btn-default" href="freeboard_list.php?page=<?php echo $page ?>">글 목록으로</a>
                    <a class="btn btn-default pull-right"
                    onclick="document.getElementById('insert_freeboard').submit();"> 수정하기 </a>
                    <a class="btn btn-default pull-right"
                    href="freeboard_delete.php?index=<?php echo $index ?>&page=<?php echo $page ?>"> 삭제하기 </a>
                </td>
            </tr>
        </form>
    </table>
